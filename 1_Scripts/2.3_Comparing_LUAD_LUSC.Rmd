...
SMD_meta_analysis_genes <- euler(list("LUAD (SMD meta-analysis)" = unique(LUAD_A1_TE_SMD_summary_overall_filtered_genes), "LUSC (SMD meta-analysis" = unique(LUSC_A1_TE_SMD_summary_overall_filtered_genes)))

plot(main = "SMD meta-analysis genes",
