...
GDCdownload(query, directory = "../../GDC_data")  # Change to an absolute path
...
counts_matched_T_NM_check <- counts_matched_T_NM[keep,]

keep <- filterByExpr(counts_matched_T_NM, min.count=20)
counts_matched_T_NM_check <- counts_matched_T_NM[keep,]
