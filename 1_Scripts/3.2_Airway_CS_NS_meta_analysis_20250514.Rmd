...
2025/05/14: I am now using the genes that were filtered using my new "sequential filtering method" in the order A1-TE and A1-TE-A2, for both LUAD and LUSC
...
for (i in 1:nrow(gene_list)){ # For each gene on the gene list
  ...
  # Append results from this to the output dataframe
    LUAD_A1_TE_SMD_summary <- rbind(persistent_linked_CS_NS_SMD_summary, df_SMD_summary)
  }
}
...
for (i in 1:nrow(gene_list)){ # For each gene on the gene list
  ...
  # Append results from this to the output dataframe
  LUAD_A1_TE_SMD_summary_overall <- rbind(persistent_linked_CS_NS_SMD_summary_overall, df_SMD_summary_overall)
