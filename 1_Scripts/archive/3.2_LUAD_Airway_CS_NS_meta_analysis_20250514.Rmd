...
for (i in 1:nrow(gene_list)){ # For each gene on the gene list
  ...
  # Input the resulting df into the SMD calculation function
  if(nrow(df_SMD_input)>0){ # IF the gene existed in any of the datasets
...
# Save summary
#write.table(LUAD_A1_TE_SMD_summary_overall, "../../2_Outputs/LUAD_A1_TE_SMD_summary_overall_A3_A4_A5_20250603.txt")
```
...
## For now will just use the gene list of LUAD-A1-TE-A2 genes since the other list is too large

gene_list <- LUAD_A1_TE_A2
...
genes_of_interest <- c("AKR1B10", "LMO2", "MAOB")
...
## Put the dataframes in a list
df_list_goi <- list(GGSE4302 = GSE4302_CS_NS_expr_matrix_genes_of_interest, GSE7895 = GSE7895_CS_NS_expr_matrix_genes_of_interest, GSE19027 = GSE19027_CS_NS_expr_matrix_genes_of_interest, GSE20257 = GSE20257_CS_NS_expr_matrix_genes_of_interest, GSE63127 = GSE63127_CS_NS_expr_matrix_genes_of_interest)
