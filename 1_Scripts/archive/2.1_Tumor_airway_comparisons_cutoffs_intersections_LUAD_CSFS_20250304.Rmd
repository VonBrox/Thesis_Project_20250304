...
### I.iii Intersection of A1/TE DEGs with A2 DEGs to give persistent cancer genes
```{r}
## Merge the lists
...
## 5.3 Comparing and filtering TM and A1TEA2 genes to give methylation related persistent cancer genes
```{r}
...
gene_sets <- list(A1_genes, TE_genes, TM_genes)
