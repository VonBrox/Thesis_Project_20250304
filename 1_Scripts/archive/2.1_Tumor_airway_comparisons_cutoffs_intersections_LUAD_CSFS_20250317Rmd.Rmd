...
What if I first intersect the unfiltered lists so that we are dealing with gene lists of the same sizes, then take genes in the top n percent for log2FC of each list, which will by definition all be the same size? Then there's only one arbitrary cutoff (the percentage). And then A2 will be a bit different since it's already starting with the genes defined as significant.



### Doing it yet another way to be more logical here
