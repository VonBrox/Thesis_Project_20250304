...
### Apply getMeanSD function to the gene list to generate a table of SMD values
...
## Add FDR column
LUSC_A1_TE_SMD_summary_overall$FDR_random <- p.adjust(as.numeric(LUSC_A1_TE_SMD_summary_overall$p_value_random), method = "BH")

head(LUSC_A1_TE_SMD_summary_overall)

# Save summary
write.table(LUSC_A1_TE_SMD_summary_overall, "../../2_Outputs/6_Meta_analysis/LUSC_A1_TE_SMD_summary_overall_20250611.txt")
```

## Trying out some filtering on the meta-analysis summary
```{r}

# LUSC_A1_TE_SMD_summary_overall_filtered <- LUSC_A1_TE_SMD_summary_overall %>%
